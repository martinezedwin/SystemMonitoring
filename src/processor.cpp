...
float Processor::Utilization() {
	...
	prevNonIdle = prev_cpu_stats[0] + prev_cpu_stats[1] + prev_cpu_stats[2] + prev_cpu_stats[5] + prev_cpu_stats[6] + prev_cpu_stats[7];
	NonIdle = cpu_stats[0] + cpu_stats[1] + cpu_stats[2] + cpu_stats[5] + cpu_stats[6] + cpu_stats[7];
